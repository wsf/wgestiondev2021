...
Private Declare Function Wiz_SingleEntryUnzip _
                Lib "unzip32.dll" (ByVal ifnc As Long, _
...
Private Declare Sub UzpVersion2 _
                Lib "unzip32.dll" (uzpv As UZPVER)
...
Private Declare Function ZpInit _
                Lib "zip32.dll" (ByRef Zipfun As ZIPUSERFUNCTIONS) As Long ' Set Zip Callbacks

Private Declare Function ZpSetOptions _
                Lib "zip32.dll" (ByRef Opts As ZPOPT) As Long ' Set Zip options

Private Declare Function ZpGetOptions _
                Lib "zip32.dll" () As ZPOPT ' used to check encryption flag only

Private Declare Function ZpArchive _
...
Public Function UZDLLRep(ByRef fname As UNZIPCBChar) As Long
    ...
    xx = MsgBox("Overwrite " & s0 & "?", vbExclamation & vbYesNoCancel, "VBUnZip32 - File Already Exists!")
...
Public Function VBUnzip(ByRef sZipFileName, _
                        ByRef sUnzipDirectory As String, _
...
'Main Subroutine
Public Function VBZip(argc As Integer, _
                      zipname As String, _
                      mynames As ZIPnames, _
                      junk As Integer, _
                      recurse As Integer, _
                      updat As Integer, _
                      freshen As Integer, _
