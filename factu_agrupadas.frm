...
Begin VB.Form frmFacturasAgrupadas 
   Caption         =   "Facturas que fueron agrupadas"
   ClientHeight    =   2625
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   12165
   ...
   Begin MSDataGridLib.DataGrid DgFacturas 
      Bindings        =   "factu_agrupadas.frx":0000
      Height          =   2565
      Left            =   0
      TabIndex        =   0
      Top             =   0
      ...
      BeginProperty Column28 
         DataField       =   "Factura_Padre"
         Caption         =   "Factura_Padre"
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            Type            =   0
            Format          =   ""
            HaveTrueFalseNull=   0
      ...
      EndProperty
   End
   Begin MSAdodcLib.Adodc bfactu_agrupadas 
      Height          =   330
      Left            =   0
      Top             =   2640
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmFacturasAgrupadas"
...
On Error Resume Next
    ...
    OrdenarDataGrid ColIndex, bfactu_agrupadas.Recordset, DgFacturas
