...
Begin VB.Form frmMovimientosXmes 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Moviemientos del mes/año seleccionado..."
   ClientHeight    =   4875
   ClientLeft      =   45
   ClientTop       =   240
   ClientWidth     =   10620
   ...
   Begin MSDataGridLib.DataGrid dg 
      Bindings        =   "movi_del_mes.frx":00D8
      Height          =   3135
      Left            =   30
      TabIndex        =   0
      Top             =   1200
   ...
   End
End
Attribute VB_Name = "frmMovimientosXmes"
...
If Err Then GrabarLog "dg_AfterColEdit", Err.Number & " " & Err.Description, Me.Name
End Sub
